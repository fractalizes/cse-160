...
class Vector3 {
    ...
    static dot(other1, other2) {
        let n = 0;
        for (let i = 0; i < 3; i++) {
          n += other1.elements[i] * other2.elements[i];
        }
        return n;
    }
    ...
    static cross(other1, other2) {
        return new Vector3([
          other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1],      // i
          -(other1.elements[0] * other2.elements[2] - other1.elements[2] * other2.elements[0]),   // j
          other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0]       // k
        ]);
    }
